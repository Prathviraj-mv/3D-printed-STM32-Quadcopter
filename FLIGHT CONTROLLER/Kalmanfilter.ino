...
float PitchOffset = 23.2; // Pitch angle offset correction
...
void gyro_signals(void) {
  ...
  AngleRoll = atan(AccY / sqrt(AccX * AccX + AccZ * AccZ)) * (180 / 3.14159265359);
  AnglePitch = -atan(AccX / sqrt(AccY * AccY + AccZ * AccZ)) * (180 / 3.14159265359) - PitchOffset; // Offset correction
}
